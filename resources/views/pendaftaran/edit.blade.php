    ...
    <form action="{{ route('users.update', $user->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="position" id="position" class="form-select">
                ...
                <option value="student" {{ old('position', $user->position) == 'student' ? 'selected' : '' }}>Siswa</option>
                <option value="teacher" {{ old('position', $user->position) == 'teacher' ? 'selected' : '' }}>Guru</option>
            </select>
        </div>
